...
namespace offsets
{
	...
	constexpr ptrdiff_t dwEntityList = 0x4DA2F44;
	constexpr ptrdiff_t dwForceAttack = 0x31D44D4;
	constexpr ptrdiff_t dwForceAttack2 = 0x31D44E0;
	constexpr ptrdiff_t dwForceBackward = 0x31D448C;
	constexpr ptrdiff_t dwForceForward = 0x31D44F8;
	constexpr ptrdiff_t dwForceJump = 0x524CEA4;
	constexpr ptrdiff_t dwForceLeft = 0x31D4480;
	constexpr ptrdiff_t dwForceRight = 0x31D44A4;
	constexpr ptrdiff_t dwGameDir = 0x62D7F8;
	constexpr ptrdiff_t dwGameRulesProxy = 0x52C018C;
	constexpr ptrdiff_t dwGetAllClasses = 0xDB2F8C;
	constexpr ptrdiff_t dwGlobalVars = 0x58ECE8;
	constexpr ptrdiff_t dwGlowObjectManager = 0x52EB540;
	constexpr ptrdiff_t dwInput = 0x51F4528;
	...
	constexpr ptrdiff_t dwPlayerResource = 0x31D2800;
	constexpr ptrdiff_t dwRadarBase = 0x51D7CBC;
	...
	constexpr ptrdiff_t dwYawPtr = 0xCEDD0002;
	...
	constexpr ptrdiff_t m_pitchClassPtr = 0x51D7F58;
	...
	constexpr ptrdiff_t find_hud_element = 0x314EE320;
